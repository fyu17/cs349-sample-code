...
class ClockView(private val model: Model): Group(), IView {
    // public properties
    var cx = 0.0
    var cy = 0.0
    ...
    private var MINUTES_LENGTH = radius - 15
    private var HOURS_LENGTH = radius - 20
    private var SECONDS_LENGTH = radius - 5
    private val HANDS_WIDTH = 3f
    private var frame = Circle()
    private var minutes = Line()
    private var hours = Line()
    private var seconds = Line()
    ...
    // model update method is agnostic
    // decorates the actual setTime method
    override fun update() {
